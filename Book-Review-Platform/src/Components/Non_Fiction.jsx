        ...
        <Navbar/>
            <div className='w-full h-full bg-gray-900 grid grid-cols-3  gap-6 p-4 flex flex-col items-center pl-4 pr-4'>
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={SapiensImg} alt="" className='h-64 w-auto object-cover rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={EducatedImg} alt="" className='h-64 w-auto rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={AtomicHabitsImg} alt="" className='h-64 w-auto rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={DiaryOfYoungGirlImg} alt="" className='h-64 w-auto  rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={MansSearchForMeaningImg} alt="" className='h-64 w-auto  rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={ThinkingFastAndSlowImg} alt="" className='h-64 w-auto  rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={OutliersImg} alt="" className='h-64 w-auto  rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={BecomingImg} alt="" className='h-64 w-auto  rounded-md' />
                ...
                <div className="h-96 w-auto p-2 bg-white border-2 rounded-md flex flex-col items-center ">
                  <img src={BornACrimeImg} alt="" className='h-64 w-auto  rounded-md' />
